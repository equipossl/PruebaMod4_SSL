...
<p></p>
  ...
  <h3>PROFESIONALES</h3>
   ...
   <!-- CLIENTES -->
    ...
    <form method="POST" action="MPControlador">
    
    
    <button class="crud" type="submit"  name = "accion" value="Listar" >VER REGISTROS DE PROFESIONALES</button>
     <button class="crud" type="submit"  name = "accion" value="Nuevo" >INGRESAR NUEVOS PROFESIONALES</button>
