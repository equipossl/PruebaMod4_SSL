...
th {
    ...
    <button class= "mprincipali" onclick="window.location.href = 'admin.jsp';">VOLVER A <br>MENU PRINCIPAL</button>
    ...
    <center>
    <div>
    <h1>FORMULAROS DE ACCIDENTES CRUD DAO (CASO CU6)</h1>
    <form method="POST" action="CControlador">
    
    
    <button class="crud" type="submit"  name = "accion" value="Listar" >VER REGISTROS REGISTRO</button>
     <button class="crud" type="submit"  name = "accion" value="Nuevo" >INGRESAR NUEVO REGISTRO</button>
