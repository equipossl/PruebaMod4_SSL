...
<html>
    <head>
        ...
        <title>añadir ASESORIA la BD</title>
    ...
    <div>
    	...
    	INGRESAR CAPACITACION:<br>    	
		<input type="radio" name="radiou" id="edad1" value="SI"> SI
		<input type="radio" name="radiou" id="edad2" value="NO"> NO<br>
		<input type="hidden" name="txtespe" size="40" value="">
		<input  class="selector-css"  type="text" name ="txtespe"  disabled style="background: #eeebeb;" required><br>
	


    	DETALLE DE CAPACITACION:
    	<input  class="selector-css"  type="text" name ="txtdeta"  ><br>
    	<br>    	
